...
class app
{
	...
	{
	    /*
        $appid='wxad1ea72eb9dd8c94';
        $appsecret='0a3899b3d78de5a3177330067cebca1d';
        //$code=$_GET['code'];
        //echo $code;
        //echo  $_SESSION["code"];
        $code= $_SESSION["code"];
        ...
        $ass="https://api.weixin.qq.com/sns/oauth2/access_token?appid=$appid&secret=$appsecret&code=$code&grant_type=authorization_code";
...
*/
      ...
      //$this->session;
     //$_SESSION['User']=array('sessionuserid'=>$user['userid'],'sessionpassword'=>$user['userpassword'],'sessionip'=>'127.0.0.1','sessiongroupid'=>$user['usergroupid'],'sessionlogintime'=>TIME,'sessionusername'=>$user['username']);
      ...
      //$this->_user=array('sessionuserid'=>$user['userid'],'sessionpassword'=>$user['userpassword'],'sessionip'=>$this->ev->getClientIp(),'sessiongroupid'=>$user['usergroupid'],'sessionlogintime'=>time(),'sessionusername'=>$user['username']);
